...
class Vcode{
	...
	private function createImage(){
		...
		//画出图片背景
		$backColor=imagecolorallocate($this->image,mt_rand(200,255),mt_rand(200,255),mt_rand(200,255));
	...
	private function setDisturbColor(){
		...
		//	$pixelColor=imagecolorallocate($this->image,mt_rand(128,255),mt_rand(128,255),mt_rand(128,255));
		//	//imagesetpixel($this->image,mt_rand(0,$this->width),mt_rand(0,$this->height),$pixelColor);
		//	imagestring($this->image,mt_rand(1,5),mt_rand(0,$this->width),mt_rand(0,$this->height),$ch[rand(0,26)],$pixelColor);
		//}
		//画出干扰线
		//for($i=0;$i<=$this->lineNum;$i++){
		//	$pixelColor=imagecolorallocate($this->image,mt_rand(0,255),mt_rand(0,255),mt_rand(0,255));
		//	imagesetpixel($this->image,mt_rand(0,$this->width),mt_rand(0,$this->height),$pixelColor);
		//	imageline($this->image,mt_rand(0,$this->width),mt_rand(0,$this->height), mt_rand(1, 99), mt_rand(1, 29), $pixelColor);
		//}
	...
	private function outputText($fontFace=''){
		...
		for($i=0;$i<$this->codeNum;$i++){
			...
			if($fontFace){
				...
				$x=floor(($this->width-16)/$this->codeNum)*$i+17;
				$y=mt_rand($fontSize+120, $this->height-14);
